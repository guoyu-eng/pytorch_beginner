...
nnmodule = Nnmodule()
# print(nnmodule)
input = torch.randn(1, 3, 32, 32)  # Example input tensor with shape (batch_size, channels, height, width)
output = nnmodule(input)
wriiter = SummaryWriter('seq_logs')
wriiter.add_graph( nnmodule, input)
wriiter.close()
